  ...
  const handleCreateStaff = async (e) => {
    ...
    try {
      ...
      if (backendErrors && typeof backendErrors === "object") {
        ...
        const firstValue = backendErrors[firstKey];
  ...
  return (
    <div>
      ...
      <div className="card border-0 shadow-sm">
        ...
        btn
        btn-sm
        ${staff.is_active ? "btn-danger" : "btn-success"}
    `}
      ...
      {showCreateModal && (
        ...
        >
          <CreateStaffForm formData={formData} handleChange={handleChange} />
        </ModalWrapper>
      )}
      ...
      {showEditModal && (
        ...
        >
          <EditStaffForm formData={formData} handleChange={handleChange} />
        </ModalWrapper>
      )}
    </div>
  );
...
// CREATE STAFF FORM
// ==========================================
function CreateStaffForm({ formData, handleChange }) {
  return (
    <>
      <InputField
        label="Username"
...
// EDIT STAFF FORM
// ==========================================
function EditStaffForm({ formData, handleChange }) {
  return (
    <>
      <InputField
        label="Username"
