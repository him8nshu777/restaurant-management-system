...
import { getComboList, getVariantList } from "../../../services/menuService";
...
export default function ComboRecipes() {
  ...
  const fetchRecipes = async () => {
    try {
      const data = await getComboRecipeList(restaurantId);
  ...
  const openEditModal = (recipe) => {
    ...
    setFormData({
      product_variant: recipe.product_variant,
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      await updateComboRecipe(selectedRecipe.id, formData);
  ...
  const handleDelete = async (id) => {
    const confirmDelete = window.confirm("Delete combo recipe?");
  ...
  return (
    <div>
      ...
      <div
        ...
        "
      >
        <h2 className="fw-bold">Combo Recipes</h2>
