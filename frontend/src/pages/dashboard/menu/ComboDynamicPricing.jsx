// src/pages/menu/ComboDynamicPricing.jsx
...
import {
  ...
  getComboDynamicPricingList,
  createComboDynamicPricing,
  updateComboDynamicPricing,
  deleteComboDynamicPricing,
} from "../../../services/menuService";

// ======================================================
// COMBO DYNAMIC PRICING
// ======================================================
export default function ComboDynamicPricing() {
  ...
  const fetchInitialData = async () => {
    try {
      ...
      const mappings = await getComboDynamicPricingList(restaurantId);
  ...
  const handleCreate = async (e) => {
    ...
    try {
      await createComboDynamicPricing(formData);
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      await updateComboDynamicPricing(selectedMapping.id, formData);
  ...
  const handleDelete = async (mappingId) => {
    ...
    try {
      await deleteComboDynamicPricing(mappingId);
  ...
  return (
    <div>
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h2 className="fw-bold">Combo Dynamic Pricing</h2>
      ...
      {showCreateModal && (
        <MappingModal
          title="Create Combo Pricing Mapping"
          formData={formData}
      ...
      {showEditModal && (
        <MappingModal
          title="Edit Combo Pricing Mapping"
          formData={formData}
          handleChange={handleChange}
          comboList={comboList}
          pricingList={pricingList}
